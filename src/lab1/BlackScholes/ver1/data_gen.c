             ...
             )
{
    ...
    ts0             = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 64);
    tx              = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 64);
    tt              = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 64);
    tvcall_compiler = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 64);
    tvput_compiler  = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 64);
    tvcall_mkl      = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 64);
    tvput_mkl       = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 64);
